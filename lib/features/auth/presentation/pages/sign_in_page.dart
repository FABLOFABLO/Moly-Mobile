      ...
      child: MolyScaffold(
          body: Column(
            children: [
              ...
              MolyTextField(text: '닉네임', hintText: '닉네임을 입력해주세요', hasIcon: false, controller: _nickNameController, minline: 1, big: false),
              const SizedBox(height: 20,),
              PwTextField(text: '비밀번호', hintText: '비밀번호를 입력해주세요', hasIcon: true, controller: _passwordController, minline: 1,),
              Spacer(),
              Padding(
